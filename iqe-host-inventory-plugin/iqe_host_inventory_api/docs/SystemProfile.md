...
**rpm_ostree_deployments** | [**list[SystemProfileRpmOstreeDeployments]**](SystemProfileRpmOstreeDeployments.md) | The list of deployments on the system as reported by rpm-ostree status --json | [optional]

...
def test_reaper_script(
    ...
    response = host_inventory.apis.hosts.get_hosts_by_id(list(all_hosts_ids))
    response_ids = {host.id for host in response}
    assert response_ids == all_hosts_ids - culled_hosts_ids
...
def test_reaper_script_uses_last_check_in(
    ...
    response = host_inventory.apis.hosts.get_hosts_by_id(list(all_hosts_ids))
    response_ids = {host.id for host in response}
    assert response_ids == all_hosts_ids - culled_hosts_ids - patched_hosts_ids

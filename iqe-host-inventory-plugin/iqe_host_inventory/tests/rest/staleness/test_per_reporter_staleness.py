...
@pytest.mark.parametrize("host_type", ["conventional", "edge"])
def test_get_hosts_filter_by_reporter_state(
    host_inventory: ApplicationHostInventory, host_type: str
) -> None:
...
@pytest.mark.usefixtures("hbi_staleness_cleanup")
@pytest.mark.parametrize("host_type", ["conventional", "edge"])
def test_delete_hosts_filter_by_reporter_state(
    host_inventory: ApplicationHostInventory,
    host_type: str,
) -> None:
    ...
    """
    hosts = create_hosts_reporter_state(host_inventory, host_type=host_type)
...
@pytest.mark.usefixtures("hbi_staleness_cleanup")
@pytest.mark.parametrize("host_type", ["conventional", "edge"])
def test_get_tags_filter_by_reporter_state(
    host_inventory: ApplicationHostInventory, host_type: str
) -> None:

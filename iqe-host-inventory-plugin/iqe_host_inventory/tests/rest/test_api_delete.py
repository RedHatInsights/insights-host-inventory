...
def test_delete_multiple_hosts_with_invalid_id(
    host_inventory: ApplicationHostInventory, invalid_host_id: str
):
    """
    ...
    bad_host_list = [host.id for host in hosts]
...
def test_delete_non_existent_host(host_inventory):
    """
...
def test_delete_bulk_filter_operating_system(
    ...
    assert response_ids == set(hosts_ids_primary[2:])

...
class Configuration:
    ...
    conf = iqe_host_inventory_api_v7.Configuration(
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = "/api/inventory/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("iqe_host_inventory_api_v7")

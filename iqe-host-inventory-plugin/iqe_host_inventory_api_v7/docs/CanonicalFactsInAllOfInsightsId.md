...
json = "{}"
# create an instance of CanonicalFactsInAllOfInsightsId from a JSON string
canonical_facts_in_all_of_insights_id_instance = CanonicalFactsInAllOfInsightsId.from_json(json)

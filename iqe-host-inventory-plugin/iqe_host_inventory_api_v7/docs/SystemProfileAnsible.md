...
**receptor_version** | **str** | The receptor version on the host | [optional]
**runner_version** | **str** | The ansible-runner version on the host | [optional]
**eda_controller_version** | **str** | The EDA controller version on the host | [optional]
**gateway_version** | **str** | The automation gateway version on the host | [optional]

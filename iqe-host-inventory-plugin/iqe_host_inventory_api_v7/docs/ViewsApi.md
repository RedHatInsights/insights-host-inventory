# iqe_host_inventory_api_v7.ViewsApi
...
with iqe_host_inventory_api_v7.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ViewsApi->api_views_clone_view:\n")
        pprint(api_response)
...
with iqe_host_inventory_api_v7.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ViewsApi->api_views_create_view:\n")
        pprint(api_response)
    except Exception as e:
...
with iqe_host_inventory_api_v7.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ViewsApi->api_views_get_view_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
with iqe_host_inventory_api_v7.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ViewsApi->api_views_get_views_list:\n")
        pprint(api_response)
    except Exception as e:
...
with iqe_host_inventory_api_v7.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ViewsApi->api_views_update_view:\n")
        pprint(api_response)
    except Exception as e:

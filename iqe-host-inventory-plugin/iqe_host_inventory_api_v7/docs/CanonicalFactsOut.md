...
canonical_facts_out_instance = CanonicalFactsOut.from_json(json)
# print the JSON string representation of the object
print(CanonicalFactsOut.to_json())

# convert the object into a dict
canonical_facts_out_dict = canonical_facts_out_instance.to_dict()
# create an instance of CanonicalFactsOut from a dict
canonical_facts_out_from_dict = CanonicalFactsOut.from_dict(canonical_facts_out_dict)
```

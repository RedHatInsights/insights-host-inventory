...
**app_data** | [**ConsumerApplicationsData**](ConsumerApplicationsData.md) |  | [optional]
...
json = "{}"
# create an instance of HostViewHost from a JSON string
host_view_host_instance = HostViewHost.from_json(json)
# print the JSON string representation of the object
print(HostViewHost.to_json())

# convert the object into a dict
host_view_host_dict = host_view_host_instance.to_dict()
# create an instance of HostViewHost from a dict
host_view_host_from_dict = HostViewHost.from_dict(host_view_host_dict)
```

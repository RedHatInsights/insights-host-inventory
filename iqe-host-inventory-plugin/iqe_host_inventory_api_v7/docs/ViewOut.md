...
json = "{}"
# create an instance of ViewOut from a JSON string
view_out_instance = ViewOut.from_json(json)
# print the JSON string representation of the object
print(ViewOut.to_json())

# convert the object into a dict
view_out_dict = view_out_instance.to_dict()
# create an instance of ViewOut from a dict
view_out_from_dict = ViewOut.from_dict(view_out_dict)
```

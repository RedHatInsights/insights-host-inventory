...
class ViewColumnConfig(BaseModel):
    ...
    key: StrictStr = Field(
        description='The column key identifier, e.g. "insights_id", "compliance.last_scan", "advisor.recommendations".'
    )
    visible: StrictBool | None = Field(
        default=True, description="Whether the column is visible in the view."
    )
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["key", "visible"]

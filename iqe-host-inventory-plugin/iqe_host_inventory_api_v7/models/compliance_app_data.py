...
class ComplianceAppData(BaseModel):
    """
    ComplianceAppData
    """
    ...
    __properties: ClassVar[list[str]] = ["policies", "last_scan"]
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if last_scan (nullable) is None
        # and model_fields_set contains the field
        if self.last_scan is None and "last_scan" in self.model_fields_set:
            _dict["last_scan"] = None

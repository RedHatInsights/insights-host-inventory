...
class NotFoundErrorResponse(BaseModel):
    ...
    title: StrictStr = Field(description="A short summary of the error.")
    detail: StrictStr = Field(description="A human-readable description of the error.")
    not_found_ids: list[StrictStr] | None = Field(
        default=None,

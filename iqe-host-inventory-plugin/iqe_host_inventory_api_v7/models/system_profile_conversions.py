...
class SystemProfileConversions(BaseModel):
    """
    Object containing information about 3rd party migration on instances
    """

    activity: StrictBool | None = Field(
        default=None, description="Whether the conversion activity has been done or not"
    )
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"activity": obj.get("activity")})

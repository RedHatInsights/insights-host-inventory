...
class SystemProfileWorkloadsOracleDb(BaseModel):
    """
    Object containing data specific to the Oracle DB workload
    """

    is_running: StrictBool | None = Field(
        default=None, description="Indicates if Oracle DB is running on the system"
    )

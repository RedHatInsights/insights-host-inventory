...
import iqe_host_inventory_api_v7.models
from iqe_host_inventory_api_v7 import rest
from iqe_host_inventory_api_v7.api_response import ApiResponse
from iqe_host_inventory_api_v7.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(iqe_host_inventory_api_v7.models, klass)

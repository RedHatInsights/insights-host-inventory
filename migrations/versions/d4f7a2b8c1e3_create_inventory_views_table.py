...
def upgrade():
    ...
    op.create_index("idx_inventory_views_org_id_created_by", "inventory_views", ["org_id", "created_by"], schema="hbi")


def downgrade():
    op.drop_index("idx_inventory_views_org_id_created_by", table_name="inventory_views", schema="hbi")

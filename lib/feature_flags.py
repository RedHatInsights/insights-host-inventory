...
FLAG_INVENTORY_FLAT_STALE_TIMESTAMP_PER_REPORTER_FILTER = "hbi.api.flat-stale-timestamp-per-reporter-filter"
...
FLAG_FALLBACK_VALUES = {
    ...
    FLAG_INVENTORY_FLAT_STALE_TIMESTAMP_PER_REPORTER_FILTER: False,
}

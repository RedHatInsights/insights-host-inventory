...
def _find_stale_hosts_using_custom_staleness(logger: Logger, session: Session, last_run_secs: int) -> ColumnElement:
...
def _find_stale_hosts_using_sys_default_staleness(logger: Logger, org_ids: list, last_run_secs: int) -> ColumnElement:

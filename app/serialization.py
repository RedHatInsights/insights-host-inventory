    ...
    for reporter in host.per_reporter_staleness:
        ...
        if should_host_stay_fresh_forever(host):
            ...
            stale_timestamp = staleness_timestamps.stale_timestamp(
                _deserialize_datetime(per_reporter_staleness[reporter]["last_check_in"]),
        ...
        per_reporter_staleness[reporter]["stale_timestamp"] = _serialize_staleness_to_string(stale_timestamp)
        per_reporter_staleness[reporter]["stale_warning_timestamp"] = _serialize_staleness_to_string(
            stale_warning_timestamp
        )
        per_reporter_staleness[reporter]["culled_timestamp"] = _serialize_staleness_to_string(delete_timestamp)

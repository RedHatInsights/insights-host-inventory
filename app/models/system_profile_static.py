...
class HostStaticSystemProfile(db.Model):
    ...
    greenboot_fallback_detected = db.Column(db.Boolean, nullable=True)
    ...
    is_marketplace = db.Column(db.Boolean, nullable=True)
    katello_agent_running = db.Column(db.Boolean, nullable=True)
    ...
    satellite_managed = db.Column(db.Boolean, nullable=True)

...
_static_normalizer = SystemProfileNormalizer()
HostStaticSystemProfileSchema = _static_normalizer.create_static_schema()


# Generate HostDynamicSystemProfileSchema dynamically from x-dynamic markers
_dynamic_normalizer = SystemProfileNormalizer()
HostDynamicSystemProfileSchema = _dynamic_normalizer.create_dynamic_schema()

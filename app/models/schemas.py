...
class HostDynamicSystemProfileSchema(MarshmallowSchema):
    ...
    captured_date = fields.AwareDateTime(allow_none=True, default_timezone=timezone.utc)
    running_processes = fields.List(fields.Str(), allow_none=True)
    last_boot_time = fields.AwareDateTime(allow_none=True, default_timezone=timezone.utc)

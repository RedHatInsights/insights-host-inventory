...
def delete(id):
    return HostEvent(strict=True).dumps({"id": id, "timestamp": datetime.utcnow(), "type": "delete", "insights_id": id.canonical_facts.insights_id, "rhel_machine_id": id.canonical_facts.rhel_machine_id,

...
egress_message_handler_success = Counter("inventory_egress_message_handler_successes",
                                         "Total amount of messages successfully written to the egress queue")
egress_message_handler_failure = Counter("inventory_egress_message_handler_failures",
                                         "Total amount of failures while writing messages to the egress queue")
egress_event_serialization_time = Summary("inventory_egress_event_serialization_seconds",

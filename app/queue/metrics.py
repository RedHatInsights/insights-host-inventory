...
rbac_fetching_failure = Counter(
    "inventory_rbac_fetching_failures", "Total amount of failures fetching RBAC data"
)
rbac_permission_failure = Counter(
    "inventory_rbac_permission_failures", "Total amount of failures authorizing with RBAC"
)

        ...
        with tracer.start_as_current_span(
            ...
            try:
                with (
                    ...
                    # Prevent session.commit() from expiring ORM objects so that
                    # post_process_rows() can serialize hosts without triggering lazy reloads.
                    # Note: must use db.session() to get the underlying Session, because

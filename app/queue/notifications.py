...
def base_notification_event(notification_type, message_id, host, context, payload):
    event = {
        "id": message_id,
    ...
    return (BaseNotificationEvent, event)
...
def host_validation_error_event(notification_type, message_id, host, detail, stack_trace=None):
    ...
    validation_error_event = base_notification_event(notification_type, message_id, host, context, payload)

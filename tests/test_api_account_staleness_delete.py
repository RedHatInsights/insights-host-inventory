...
def test_delete_staleness_rbac_allowed(
    subtests, mocker, api_delete_account_staleness, db_create_account_staleness_culling, enable_rbac
):
    ...
    for response_file in ACCOUNT_STALENESS_WRITE_ALLOWED_RBAC_RESPONSE_FILES:
        ...
        with subtests.test():
            ...
            db_create_account_staleness_culling(
                conventional_staleness_delta=1,
                conventional_stale_warning_delta=7,
                conventional_culling_delta=14,
                immutable_staleness_delta=7,
            ...
            response_status, _ = api_delete_account_staleness()

            assert_response_status(response_status, 204)


def test_delete_staleness_rbac_denied(subtests, mocker, api_delete_account_staleness, enable_rbac):
    get_rbac_permissions_mock = mocker.patch("lib.middleware.get_rbac_permissions")

...
from tests.utils.db_utils import DB_FACTS
from tests.utils.db_utils import DB_FACTS_NAMESPACE
from tests.utils.db_utils import DB_NEW_FACTS
from tests.utils.db_utils import get_expected_facts_after_update
...
def test_replace_facts_to_multiple_hosts_with_branch_id(db_create_multiple_hosts, db_get_hosts, api_put_host):
    ...
    response_status, response_data = api_put_host(facts_url, DB_NEW_FACTS)
...
def test_replace_facts_to_multiple_hosts_with_empty_key_value_pair(
    ...
    response_status, response_data = api_put_host(facts_url, new_facts)
    assert_response_status(response_status, expected_status=200)
...
def test_replace_facts_to_namespace_that_does_not_exist(db_create_multiple_hosts, api_patch_host):
    ...
    response_status, response_data = api_patch_host(facts_url, new_facts)
    assert_response_status(response_status, expected_status=400)

...
def test_get_filtered_by_search_tags_of_multiple_hosts(mq_create_four_specific_hosts, api_get, subtests):
    ...
    for search, results in (
        ...
        (
            "To",
            {
                created_hosts[0].id: [{"namespace": "insights-client", "key": "tag", "value": "ToFind"}],
                created_hosts[1].id: [],
                created_hosts[2].id: [],
                created_hosts[3].id: [],
            },
        ...
        (
            "key1",
            {
                created_hosts[0].id: [{"namespace": "satellite", "key": "key1", "value": "val1"}],
                created_hosts[1].id: [{"namespace": "satellite", "key": "key1", "value": "val1"}],
                created_hosts[2].id: [],
                created_hosts[3].id: [],
            },
        ),

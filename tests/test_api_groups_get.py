...
def test_get_groups_RBAC_denied(subtests, mocker, api_get, _enable_rbac):
...
def test_get_groups_RBAC_allowed_specific_groups(mocker, db_create_group, api_get, _enable_rbac):
    get_rbac_permissions_mock = mocker.patch("lib.middleware.get_rbac_permissions")

...
class TestEndToEndOutboxScenarios:
    ...
    def test_create_host_saves_to_outbox(self, event_producer, db_create_host, flask_app):  # noqa: ARG002, pytest needs it
    ...
    def test_update_host_saves_to_outbox(self, event_producer, db_create_host, flask_app):  # noqa: ARG002, pytest needs it
    ...
    def test_delete_host_saves_to_outbox(self, event_producer, db_create_host, flask_app):  # noqa: ARG002, pytest needs it
    ...
    def test_multiple_operations_create_separate_outbox_records(self, event_producer, db_create_host, flask_app):  # noqa: ARG002, pytest needs it

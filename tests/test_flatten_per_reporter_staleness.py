...
def test_flatten_nested_to_flat_format(flask_app, db_create_host):
...
def test_flatten_already_flat_format_unchanged(flask_app, db_create_host):
...
def test_flatten_mixed_reporters(flask_app, db_create_host):
...
def test_flatten_empty_per_reporter_staleness(flask_app, db_create_host):
...
def test_flatten_dry_run_mode(flask_app, db_create_host):
...
def test_flatten_multiple_orgs(flask_app, db_create_host):
...
def test_flatten_chunked_processing(flask_app, db_create_host):

...
APPLICATION_TEST_DATA = [
    ...
    pytest.param(
        ...
        {"policies": [{"id": "aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee", "name": "Policy 1"}], "last_scan": datetime.now(UTC).isoformat()},
...
class TestHostAppDataValidation:
    ...
    def test_compliance_data_datetime_valid(self, host_app_consumer, db_create_host):
        ...
        compliance_data = {"policies": [{"id": "aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee", "name": "Policy 1"}],

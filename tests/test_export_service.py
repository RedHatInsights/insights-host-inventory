...
def test_handle_create_export_request():
    ...
    resp = handle_export_message(message=export_message, event_producer=None, notification_event_producer=None)
...
def test_handle_create_export_missing_field(field_to_remove):
    with pytest.raises(ValidationError):
        ...
        handle_export_message(message=export_message, event_producer=None, notification_event_producer=None)
